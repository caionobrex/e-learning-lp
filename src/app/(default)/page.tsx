...
export const CourseCard = ({ course }) => {
  return (
    <Link
      ...
      className="bg-primary-400 rounded-2xl transition-all duration-500 lg:hover:-translate-y-5 block"
    >
      ...
      <div className="p-6">
        ...
        <h2 className="mt-2 text-white font-bold text-lg">{course.name}</h2>
  ...
  return (
    <div className="bg-transparent border border-gray-600 rounded-3xl grid grid-cols-4 p-6 gap-x-6 items-center transition-all duration-500 lg:hover:-translate-y-5">
      ...
      <div className="col-span-3">
        <h3 className="mt-2 text-white font-bold text-lg">{category.name}</h3>
  ...
  return (
    <>
      <Image
        src={Circle}
        alt="Dashed Line"
        className="absolute -right-0 -top-72 -z-20 animate-pulse"
      />
      <main className="min-h-screen pb-28">
          ...
          <div className="relative">
            ...
            <div className="lg:absolute left-1/2 -top-4 lg:-top-5 2xl:-top-8 lg:-translate-x-1/2 w-full h-full flex flex-col lg:items-center">
              ...
              <div className="flex flex-col gap-y-4 items-center gap-x-8 mt-10 sm:flex-row">
                <button
                  type="button"
                  className="border-2 py-3 px-10 rounded-bl-2xl rounded-tr-2xl w-full lg:w-auto hover:bg-primary transition-all"
                >
                  Join as Student
                </button>
                <button
              ...
              <Image
                src={Rocket}
                alt="Dashed Line"
                className="lg:absolute lg:block -bottom-[26rem] lg:-bottom-[36rem] xl:-bottom-[30rem] xl:left-52 2xl:left-64 -z-10"
              />
            </div>
            <Image
              src={Pencil}
              alt="Dashed Line"
              className="hidden absolute xl:top-1/3 xl:block xl:left-28 -z-20"
            />
            <Image
              src={Arrow}
              alt="Dashed Line"
              className="hidden absolute top-1/2 xl:block -translate-y-1/2 left-72 -z-20"
            />
            <Image
              src={Internet}
              alt="Dashed Line"
              className="hidden absolute top-1/2 xl:block -translate-y-1/2 right-36 -z-20"
            />
            <Image
              src={HeroEllipse}
              alt="Dashed Line"
              className="absolute -bottom-[2rem] lg:-bottom-[36rem] 2xl:left-40 -z-20"
            />
          </div>
        </section>

        <section className="custom-container mt-10 lg:mt-[34rem] xl:mt-[26rem]">
          <span className="text-primary text-center block font-bold text-sm">
            Join Dominie At Best
          </span>
          <h2 className="text-center text-3xl text-white font-semibold mt-2">
            Nossos Cursos
          </h2>
              ...
              <li key={course.id}>
                <CourseCard
                  course={{
                    ...course,
                    category: {
                      name: course.CoursesOnCategories[0].category.name,
                    },
                  }}
                />
              </li>
          ...
          <div className="flex justify-center mt-10">
            <button
              type="button"
              className="border-2 py-3 px-10 rounded-bl-2xl rounded-tr-2xl text-white hover:bg-primary transition-all"
            >
              Saiba Mais
            </button>
          </div>
        ...
        <section className="mt-24 lg:mt-28 relative">
          <Image
            src={Circle}
            alt="Dashed Line"
            className="absolute -right-0 -top-96 -z-20"
          />
        ...
        <section className="mt-20 custom-container lg:mt-40 relative">
          <Image
            src={HeroEllipse}
            alt="Dashed Line"
            className="absolute -top-36 lg:-top-96 -z-20"
          />
        ...
        <section className="mt-16 lg:mt-32 relative">
          <div className="custom-container grid lg:grid-cols-2 gap-y-6 items-center">
            <div>
              ...
              <p className="text-white font-semibold text-3xl mt-6">
              ...
              <button
                type="button"
                className="border-2 py-3 px-10 rounded-bl-2xl rounded-tr-2xl w-full lg:w-auto mt-12 text-white hover:bg-primary transition-all"
              >
                Learn More
              </button>
            </div>
